...
deep_info = {
    "find_master_access": "* Find Master Access: Master is a scheme table that contains all the information,\n  "
    ...
    "mongo_db_command": "* Mongo DB Command: The attacker may use some of the common commands in mongoDB, that are not so\n  "
                        "frequent, so it is suspicious he use this characters.\n",

    "cstyle_comment": "* C-Style Comment: The user is trying to add some C-style comments into your SQL query maybe in order\n  "
                      "to delete the information after the comments.\n",
    ...
    "write_into_outfile": "* Write Into Outfile: This function writes the selected rows to a file, so the attacker can write some\n  "
    ...
    "concat_command": "* Concat Command: The concat command is another way for the attacker to check if his injection can work.\n  "
    ...
    "if_command": "* If Command: The if statement can be used to check some conditions in it.\n  "
                  "With that said, an attacker can use this statement to check.\n",
    ...
    "user_info_disclosure": "* User Information Disclosure: pg_user is a specific command that returns"
                            " information about all the users\n  In a specific database, in the wrong "
    ...
    "grant_revoke": "* Grant/Revoke: The grant or revoke functions are letting the attacker the option "
                    "to manipulate and change the permissions of the database.\n",
    ...
    "update": "* Update: The update command modifies and changes values that appear in the database.\n  "
              "An attacker can put a malicious code in a single row, and then other users "
    ...
    "exist": "* Exist: The exist function checks if a row or database exist.\n  That can be useful "
             "for a future hacker, in order to set his environment for hacking, and check the "
             "settings of the database.\n",

    "truncate": "* Truncate: Truncate table deletes a data inside a table.\n  "
                "A hacker can use it for deleting very important information from the database "
    ...
    "drop": "* Drop: Drop function can delete raw, table and even database, potential hacker can use it for "
