***this file is very important to read before installing and running our waf project***
--the program make her own ip tables rules when it start and close, just like that, it directs all the packet
