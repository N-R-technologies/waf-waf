...
class Detector:
    ...
    def detect(request):
        ...
        :rtype: tuple
        """
        findings_graph = [0 for risk in range(NUM_OF_RISKS)]
        all_risks_info = ""
        ...
        for basic_check_name, basic_check in basic_checks:
            ...
            if basic_check_result > RiskLevel.NO_RISK:
                findings_graph[int(basic_check_result)] += 1
        ...
        for advanced_check_name, advanced_check in advanced_checks:
            ...
            if advanced_check_result > RiskLevel.NO_RISK:
                findings_graph[int(advanced_check_result)] += 1
    ...
    def summarize_info(risks_info):
        ...
        :rtype: string
        """
        return "General Information: " + sqlinjection_info.general_info + '\n' + risks_info + '\n' + sqlinjection_info.links_for_info
