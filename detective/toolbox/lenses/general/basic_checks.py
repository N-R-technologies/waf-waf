...
class BasicChecks:
    ...
    @staticmethod
    def html_breaking_injections(request):
        return RiskLevels.SLIGHT if re.search(r"""(?:\"[^\"]*[^-]?>)|(?:[^\w\s]\s*\\/>)|(?:>\")""", request) \
            else RiskLevels.NO_RISK

    @staticmethod
    def attribute_breaking_injections(request):
    ...
    @staticmethod
    def firefox_url_injections(request):
        return RiskLevels.MODERATE \
    ...
    @staticmethod
    def conditional_sql_injection(request):
        return RiskLevels.MODERATE \
            if re.search(r"""(?:[\s()]case\s*\()|(?:\)\s*like\s*\()|(?:having\s*[^\s]+\s*[^\w\s])|(?:if\s?\([\d\w]\s*[=<>~])""", request) \
            else RiskLevels.NO_RISK

    @staticmethod
    def classic_sql_injection_1(request):
        return RiskLevels.MODERATE \
    ...
    @staticmethod
    def classic_sql_injection_2(request):
        return RiskLevels.MODERATE \
    ...
    @staticmethod
    def sql_authentication_1(request):
    ...
    @staticmethod
    def sql_authentication_2(request):
        return RiskLevels.CRITICAL \
    ...
    @staticmethod
    def sql_authentication_3(request):
        return RiskLevels.CRITICAL \
    ...
    @staticmethod
    def chained_sql_injection_1(request):
        return RiskLevels.MODERATE \
    ...
    @staticmethod
    def chained_sql_injection_2(request):
        return RiskLevels.MODERATE \
    ...
    @staticmethod
    def injection_attempts_3(request):
        return RiskLevels.CRITICAL \
