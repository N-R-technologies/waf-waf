...
class BasicChecks:
    ...
    def cstyle_comment(request):
        ...
        run from the input Common C-style comment
    ...
    def find_in_set(request):
        """
        This function will check if the user tries to
        run from the input common MySQL function “find_in_set”
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def master_access(request):
        """
        This function will check if the user tries to
        run from the input SQLite information disclosure “sqlite_master”
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def user_disclosure(request):
        """
        This function will check if the user tries to
        run from the input MySQL information disclosure “mysql.user”
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def user_info_disclosure(request):
        """
        This function will check if the user tries to
        run from input the PgSQL information disclosure “pg_user”
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def db_info_disclosure(request):
        """
        This function will check if the user tries to
        run from input the PgSQL information disclosure “pg_database”
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def shadow_info_disclosure(request):
        ...
        to run from input the PgSQL information disclosure “pg_shadow”
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def load_file_disclosure(request):
        """
        This function will check if the user tries
        to run from the input blind mysql disclosure "load_file"
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def load_data_disclosure(request):
        """
        This function will check if the user tries
        to run from the input blind mysql disclosure "load_data"
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def write_into_outfile(request):
        """
        This function will check if the user tries to
        run from the input MySQL file write "into outfile"
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def concat_command(request):
        """
        This function will check if the user tries to
        run from the input the command concat
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def blind_benchmark(request):
        """
        This function will check if the user tries to
        run from the input blind sql benchmark
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def blind_sql_sleep(request):
        """
        This function will check if the user tries to
        run from the input blind sql sleep
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def blind_tsql(request):
        """
        This function will check if the user tries to
        run from input the blind tsql "waitfor"
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def length_command(request):
        """
        This function will check if the user tries to
        run from input the mysql length command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def hex_command(request):
        """
        This function will check if the user tries to
        run from input the mysql hex/unhex command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def base64_command(request):
        """
        This function will check if the user tries to
        run from input the mysql to base 64/ from base 64 command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def oct_command(request):
        """
        This function will check if the user tries to
        run from input the SQL oct command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def ord_command(request):
        """
        This function will check if the user tries to
        run from input the SQL ord command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def ascii_command(request):
        """
        This function will check if the user tries to
        run from input the SQL ascii command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def bin_command(request):
        """
        This function will check if the user tries to
        run from input the SQL bin command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def char_command(request):
        """
        This function will check if the user tries to
        run from input the SQL char command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def substr_command(request):
        """
        This function will check if the user tries to
        run from input the SQL substr command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def user_command(request):
        """
        This function will check if the user tries to
        run from input the SQL user command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def version_command(request):
        """
        This function will check if the user tries to
        run from input the SQL version command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def system_variable(request):
        """
        This function will check if the user tries to
        run from input the SQL system variable command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def if_command(request):
        """
        This function will check if the user tries to
        run from input the SQL if command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels"""
    ...
    def ifnull_command(request):
        """This function will check if the user tries to
        run from input the SQL ifnull command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def case_command(request):
        """
        This function will check if the user tries to
        run from input the SQL case command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def exec_command(request):
        """
        This function will check if the user tries to
        run from input the MSSQL exec command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def create_command(request):
        """
        This function will check if the user tries to
        run from input the SQL create command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def mongo_db_command(request):
        """
        This function will check if the user tries to
        run from the input Common mongoDB commands
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def db_command(request):
        """
        This function will check if the user tries to
        run from input the DATABASE command
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
    ...
    def alter(request):
        """
        This function will check if the user tries to
        run from input the alter table sql statement
        :param request: the sub statement
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
        """
        return RiskLevels.MODERATE if re.search(r"""alter\s+table\s+.+?\s+(?:add|drop\s+column)\s+.+""", request) \
            else RiskLevels.NO_RISK
    ...
    def exist(request):
        """
        This function will check if the user tries to
        run from input the where sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
    ...
    def create(request):
        """
        This function will check if the user tries to
        run from input the create sql statement
        :param request: the sub statement
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
        """
        return RiskLevels.CRITICAL if re.search(r"""create\s+(?P<createinfo>database|table|index|(?:or\s+replace\s+)?view)\s+.+""", request) \
            else RiskLevels.NO_RISK
    ...
    def update(request):
        """
        This function will check if the user tries to
        run from input the update sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
    ...
    def delete(request):
        """
        This function will check if the user tries to
        run from input the delete sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
    ...
    def drop(request):
        """
        This function will check if the user tries to
        run from input the drop sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
        """
        return RiskLevels.CATASTROPHIC if re.search(r"""drop\s+(?P<deleteinfo>database|index|table|view)\s+.+""", request) \
            else RiskLevels.NO_RISK
    ...
    def truncate(request):
        """
        This function will check if the user tries to
        run from input the truncate sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
    ...
    def insert(request):
        """
        This function will check if the user tries to
        run from input the insert sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
    ...
    def select_union(request):
        """
        This function will check if the user tries to
        run from input the select union sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
        ...
        return RiskLevels.MODERATE \
            if re.search(r"""select\s+.+?\s+from\s+.+?\s+union(?:\s+all)?\s+select\s+.+?\s+from\s+.+""", request) \
            else RiskLevels.NO_RISK
    ...
    def select_into(request):
        """
        This function will check if the user tries to
        run from input the select into sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
    ...
    def select_from(request):
        """
        This function will check if the user tries to
        run from input the select from sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according the findings
        :rtype: enum RiskLevels
    ...
    def or_statement(request):
        """
        This function will check if the user tries to
        run from input an or sql statement
        :param request: the user's request
        :type request: string
        :return: the dangerous level according to the findings
        :rtype: enum RiskLevels
