...
deep_info = {
    "include_site": "* Include Site: An attacker tried to include other web site in the URL, in order to\n  "
                    "inject your server a malicious code.\n",

    "q_mark_after_url": "* A '?' After the URL: An attacker tried to inject your server with ending with "
                        "question mark.\n  This question mark, like a comment, disable everything comes after it.\n",

    "off_site_url": "* Off Site URL: A potential attacker can enter to the server's parameter a\n  "
                    "URL or even an IP address which leads to a malicious code.\n",

    "malicious_file_injection": "* Malicious File Injection: An attacker can use RFI in order to inject to "
                                "your database\n  malicious files.\n"
}
